    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if user is not None:
                ...
                if user.role == 'admin':
                    return redirect('admin_dashboard:dashboard')
                elif user.role == 'employee' and user.sub_role == 'faculty':
                    return redirect('employee:faculty_dashboard')
                elif user.role == 'employee' and user.sub_role == 'hr':
                    return redirect('employee:hr_dashboard')
                elif user.role == 'employee' and user.sub_role == 'teacher':
                    return redirect('employee:teacher_dashboard')
