...
class WeekendCalendar(models.Model):
    ...
    is_holiday = models.BooleanField(default=False)  # Add this field for government holidays
    description = models.CharField(max_length=100, blank=True)
    
    def __str__(self):
        return f"{self.date} - {'Weekend' if self.is_weekend else 'Holiday' if self.is_holiday else 'Weekday'}"