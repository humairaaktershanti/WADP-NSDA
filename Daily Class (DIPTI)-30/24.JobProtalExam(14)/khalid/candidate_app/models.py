...
class jobApplicationModel(models.Model):
    job = models.OneToOneField(jobModel, on_delete = models.CASCADE, null = True)
    candidate = models.OneToOneField(candidateProfileModel, on_delete = models.CASCADE, null = True)
