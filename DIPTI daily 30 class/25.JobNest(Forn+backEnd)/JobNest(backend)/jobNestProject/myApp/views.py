...
@login_required(login_url='login')
def dashboard_recruiter(req):
    return render(req, 'dashboard_recruiter.html')

@login_required(login_url='login')
def dashboard_seeker(req):
    return render(req, 'dashboard_seeker.html')

@login_required(login_url='login')
def profile_recruiter(req):
    return render(req, 'profile_recruiter.html')

@login_required(login_url='login')
def job_post(req):
    return render(req, 'job_post.html')
...
@login_required(login_url='login')
def profile_seeker(req):
    return render(req, 'profile_seeker.html')