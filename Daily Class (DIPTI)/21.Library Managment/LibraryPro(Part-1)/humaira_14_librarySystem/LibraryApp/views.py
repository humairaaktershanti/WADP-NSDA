...
def librarianProfile(req):
    return render(req, 'librarianProfile.html')
    ...
    if req.method=='POST':
        ...
        if password == confirm_password:
            ...
            if userTypes == 'Librarian':
                    userLib = librarianProfileModel.objects.create_user(user=user)
                    userLib.save()       
            else:
                    userLib = studentProfileModel.objects.create_user(user=user)
                    userLib.save()
